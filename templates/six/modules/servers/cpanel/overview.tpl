...
<script src="templates/six/modules/servers/cpanel/client-extend.js"></script>
            ...
            <div class="panel-body text-center cpanel-usage-stats">
                ...
                <div class="row">
                    <div class="col-sm-5 col-sm-offset-1 col-xs-6" id="diskUsage">
                        ...
                        <br /><br />
                        <input type="text" value="{$diskpercent|substr:0:-1}" class="usage-dial" data-fgColor="#444" data-angleOffset="-125" data-angleArc="250" data-min="0" data-max="20" data-readOnly="true" data-width="100" data-height="80" />
                        <br /><br />
                    ...
                    <div class="col-sm-5 col-xs-6" id="bandwidthUsage">
                        ...
                        <br /><br />
                        <input type="text" value="{$bwpercent|substr:0:-1}" class="usage-dial" data-fgColor="#d9534f" data-angleOffset="-125" data-angleArc="250" data-min="0" data-max="100" data-readOnly="true" data-width="100" data-height="80" />
                        <br /><br />
                        {$bwusage} M / {$bwlimit} M
                    </div>
                </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default" id="cPanelServerStats">
            <div class="panel-heading">
                <h3 class="panel-title">cPanel Server Status</h3>
            </div>
            <div class="panel-body text-center cpanel-usage-stats">
                <div class="col-sm-4 col-xs-6" id="oneMinuteLoad">
                    <strong>One Minute Load Average</strong>
                    <br /><br />
                    <input type="text" value="{$loadAverage.one}" class="usage-dial" data-fgColor="#d9534f" data-angleOffset="-125" data-angleArc="250" data-min="0" data-max="10" data-readOnly="true" data-width="100" data-height="80" />
                    <br /><br />
                    {$loadAverage.one}  Processes Wanting to Run On Average
                </div>
                <div class="col-sm-4 col-xs-6" id="fiveMinuteLoad">
                    <strong>Five Minute Load Average</strong>
                    <br /><br />
                    <input type="text" value="{$loadAverage.five}" class="usage-dial" data-fgColor="#d9534f" data-angleOffset="-125" data-angleArc="250" data-min="0" data-max="10" data-readOnly="true" data-width="100" data-height="80" />
                    <br /><br />
                    {$loadAverage.five} Processes Wanting to Run On Average
                </div>
                <div class="col-sm-4 col-xs-6" id="fifteenMinuteLoad">
                    <strong>Fifteen Minute Load Average</strong>
                    <br /><br />
                    <input type="text" value="{$loadAverage.fifteen}" class="usage-dial" data-fgColor="#d9534f" data-angleOffset="-125" data-angleArc="250" data-min="0" data-max="10" data-readOnly="true" data-width="100" data-height="80" />
                    <br /><br />
                    {$loadAverage.fifteen}  Processes Wanting to Run On Average
                </div>
            </div>
        </div>
    </div>
...
{if $systemStatus == 'Active'}
    ...
    <div class="panel panel-default" id="cPanelQuickFtpPanel">
        <div class="panel-heading">
            <h3 class="panel-title">Quick Create an FTP Account</h3>
        </div>
        <div class="panel-body">

            {include file="$template/includes/alert.tpl" type="success" msg="Ftp Account created successfully" textcenter=true hide=true idname="ftpCreateSuccess"}

            {include file="$template/includes/alert.tpl" type="danger" msg='<span id="ftpCreateFailedErrorMsg"></span>' textcenter=true hide=true idname="ftpCreateFailed"}

            <form id="frmCreateFtpAccount" onsubmit="doFtpCreate();return false">
                <input type="hidden" name="id" value="{$serviceid}" />
                <div class="row">
                    <div class="col-sm-6">
                        <div class="input-group">
                            <input type="text" name="ftp_prefix" class="form-control" placeholder="{$LANG.cPanel.usernamePlaceholder}">
                            <span class="input-group-addon">@{$domain}</span>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <input type="password" name="ftp_pw" class="form-control" placeholder="{$LANG.cPanel.passwordPlaceholder}">
                    </div>
                    <div class="col-sm-3">
                        <button type="submit" class="btn btn-primary btn-block" />
                        <i class="fa fa-plus" id="btnCreateFtpLoader"></i>
                        {$LANG.cPanel.create}
                        </button>
                    </div>
                </div>
